...
export default function SubSection2About2() {
    return (
        <div className="left-container-about-sec-2">
            <div data-aos="fade-left" className="title-left-about-sec-2">PRODUTOS E SERVIÇOS</div>
            <div data-aos="fade" className="text-left-about-sec-2">Os produtos da PC Garage têm um detalhe fundamental: a prioridade com qualidade em cada
