...
export default function SubSection3About2() {
    ...
    return (
        <div className="left-container-about-section-2">
            ...
            <div data-aos="fade" className="text-left-about-section-2">Depois de três anos, conseguimos colocar em prática a ideia de reunir todos nossos itens em
...
em Novo Hamburgo, no Rio Grande do Sul, aguardando os contatos de vocês.</div>
            <img data-aos="fade" className="image-section-2" src={nossahistoria} alt="hands" />
        </div>
    )
}